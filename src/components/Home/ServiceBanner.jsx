  ...
  return (
    <div className="container-x mx-auto mb-[60px]">
      <div
        ...
        className="best-services w-3/4 mx-auto flex flex-col space-y-10 lg:space-y-0 lg:flex-row lg:justify-between lg:items-center lg:h-[110px] px-10 lg:py-0 py-10"
      >
        <div className="item">
